...
\begin{align}
	x=0 && x = \pm\sqrt{r-1}
\end{align}
Therefore there is always a critical point at \(x=0\) but also two more which move with \(r\) and appears when \(r\ge1\). Looking at the derivative of the right hand side at \(x=0\)
\begin{equation}
	f'(0) = -1 + \left.\frac{r\ins{1+x^2}-2rx^2}{\ins{1+x^2}^2}\right|_{x=0}=r-1
\end{equation}
Therefore this is a supercritical pitchfork. As for the other point
\begin{equation}
...
\end{equation}
So the critical point is always stable. This is a saddle node bifurcation.
\begin{figure}[!htb]
	\begin{center}
