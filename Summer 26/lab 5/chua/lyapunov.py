    ...
    for k, (label, kind, src) in enumerate(groups):
        ...
        for rec in records:
            ...
            rows.append(dict(res, sweep=label, filename=rec.name,
                             rpot=rec.rpot,
                             rpot_source=rec.info.get('rpot_source', f'divider sidecar (R0={R0:g} ohm)'),
