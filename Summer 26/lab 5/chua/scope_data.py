...
# Fixed resistor R0 in ohm. 992 is the value measured on this bench and the one every
# committed *_rpot.csv sidecar was computed with. The experiment plan quotes 990 ohm;
# to switch, change this value and rerun batch_rpot.py (all Rpot scale by 990/992).
R0 = 992.0
RPOT_MAX = 1000.0
