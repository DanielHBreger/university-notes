...
\begin{description}
    ...
    \item[Combination of protons and electrons] \(e + p \rightarrow n + \nu_e\) which is possible when \begin{equation*}k_B T \gg \ins{m_n-m_p}c^2\end{equation*}.
\end{description}
