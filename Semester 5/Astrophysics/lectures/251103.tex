...
The portion of mass of hydrogen of the total mass is denoted by \(X\), helium by \(Y\), and metals, which are all the elements heavier than helium and are denoted by \(Z=\frac{M_{metals}}{M}\). For our sun:
