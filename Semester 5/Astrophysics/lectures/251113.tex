...
\end{align}
and the temperature at the core of the sun is \(T_c \simeq \qty{1e7}{\kelvin}\) and using the expression for the energy at the core
\begin{equation}
	\frac{3}{2}k_B T = E \implies E_c \sim keV
\end{equation}
...
\end{align}
and then
\begin{equation}\label{fusionrate}
	r_{xi} = \int\sigma(E)v(E)n_x\diff{n_i}{E}\dd E
\end{equation}
with the Stefan-Boltzmann law being
\begin{equation}
	\diff{n_i}{E} = \frac{2n_i}{\sqrt{\pi}}\frac{\sqrt{E}}{\ins{k_B T}^{3/2}}e^{-\frac{E}{k_B T}}
\end{equation}
...
where our energy is
\begin{equation}
	E = \frac{3}{2}k_B T = \frac{z_1z_2e^2}{r_1}
\end{equation}
and our potential is
\begin{equation}
	V(r) = \begin{cases}
		\frac{Z_A Z_B e^2}{r} & r > r_0\\
		0 & r < r_0
	\end{cases}
\end{equation}
...
\begin{equation}
	P \approx e^{-\frac{2\sqrt{\mu E}}{\hbar}\frac{Z_A Z_B e^2}{E}}
\end{equation}
...
where
\begin{align}
	E_G = \ins{\pi \alpha Z_A Z_B}^2 2\mu c^2 && \alpha = \frac{e^2}{\hbar c} \approx \frac{1}{137}
\end{align}