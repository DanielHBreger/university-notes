...
\begin{figure}[!htb]
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{Schematic of the Gamow peak (integrand contributions vs. energy).}
\end{figure}
...
\begin{wrapfigure}[24]{r}{0pt}
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{Power-law approximation on a log--log plot (schematic).}
\end{wrapfigure}
...
\begin{align}
	\epsilon_0 = \SI{0.1}{\erg\per\gram\per\second} && \rho_0 = \SI{1}{\gram\per\centi\meter^3} && T_0 = \SI{e7}{\kelvin} && x_i=x_x=0.7
\end{align}
then we find
\begin{equation}
