...
\end{equation}
\subsubsection{The gravitational element \(\delta F_g\)}
...
\begin{equation}
    M_s = \frac{v}{c_s}
\end{equation}
If we look at the ratio between the dynamic element of Navier--Stokes and the pressure element
\begin{equation}
...
\end{equation}
If \(R_e\) is small the viscosity is important. If \(R_e\) is large then viscosity is negligible.
