We can rearrange the Friedmann equations into
\begin{gather}
...
\begin{equation}
    \frac{\dot{R}}{R} = H = \sqrt{\frac{8\pi G \rho}{3}}
\end{equation}
from observations we know \(H_0 = \frac{8\pi G}{3}\rho_0\). We define a critical density as
\begin{equation}
    \rho_c = \frac{3H^2}{8\pi G}
\end{equation}
inserting current values we find \(\rho_c = \qty{1.4e11}{\frac{M_\mathSun}{\mega\parsec^3}}\). We can then define a density parameter as
\begin{equation}
...
which has solution
\begin{equation}
    R(t) \propto e^{Ht} = e^{\sqrt{\frac{\Lambda}{3}}t}
\end{equation}