...
\begin{equation}
	\eta = \frac{\Delta E}{M_{He}c^2} = \SI{0.7}{\percent}
\end{equation}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=0.5\textwidth]{images/IMG_0474}
...
\begin{align}
	R_\mathSun = \SI{7e10}{\cm} && T_C = \SI{1.5e7}{\kelvin} && \rho_C = \SI{150}{\gram.\cm^{-3}}\\
	\overline{\rho} = \SI{1.4}{\gram.\cm^{-3}} && P_C = \SI{e11}{\atm} && M_\mathSun = \SI{2e33}{\gram}\\
