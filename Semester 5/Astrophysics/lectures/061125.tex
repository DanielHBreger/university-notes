...
\begin{align}
	...
	&\simeq (3.8\times 10^{33} erg/s)(4.6 Gyr)\\
	&= 5.6 \times 10^{50} erg
\end{align}
...
\begin{equation}
	t_\mathSun = \frac{E_{nuc}}{L_\mathSun} \approx 100 Gyr
\end{equation}

but since the sun hasn't burned through all the hydrogen it has access to, we can replace

\begin{equation}
	M_\mathSun \rightarrow M_{core} \approx 5\% M_\mathSun
\end{equation}
...
\begin{align}
	R_\mathSun &= 7\times 10^10 cm && T_C &= 1.5\times 10^7 && \rho_C = 150 g cm^{-3}\\
	\overline{\rho} &= 1.4 g cm^{-3} && P_C &= 10^{11} Atm && M_\mathSun = 2\times 10^{33}\\
	L_\mathSun &= 3.8\times 10^{33} erg/s
\end{align}
