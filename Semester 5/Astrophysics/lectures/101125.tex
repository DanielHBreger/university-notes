...
\end{equation}
for context of how much energy that is, we know that the sun's luminosity is \(l_\mathSun = \qty{4e33}{\erg\per\sec}\). This means that per second it produces \(\qty{4e26}{\joule}\), which is \(10^6\) times the yearly consumption of all humanity.