...
\end{equation}
\emph{The lecture notes here develop the fermi energy, I skip it as it's included in the prerequisite course Statistical Mechanics.} In conclusion, we'll find particles with high energy and momentum regardless of the temperature. They're being forced to be such by Pauli's exclusion principle.
