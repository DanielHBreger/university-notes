...
\begin{equation}
    x_{ph} = \frac{c}{H_0} = \qty{5.5}{\giga\parsec}
\end{equation}
The cosmological horizon is the maximum distance light we emit now can travel to in the future. To calculate it, we look back to the FLRW metric:
\begin{equation}
...
\begin{equation}
    \lambda_{obs} = \frac{R_0}{R_{em}}\, \lambda_{em} = \frac{1}{a}\,\lambda_{em}
\end{equation}
