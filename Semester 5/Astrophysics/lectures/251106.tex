\subsection{The meaning of the symbol \texorpdfstring{$\simeq$}{≈}}
...
\begin{align}
	...
	\text{(assuming \(\rho=\text{const.}\))}&= \frac{3}{5}G\frac{M_\mathSun^2}{R_\mathSun}\\
	&= \SI{2e48}{\erg}
\end{align}
...
\begin{wrapfigure}[16]{r}{0pt}
	...
	\caption{The temperature in the Sun as a function of the distance from its core, the relative pressure compared to the core, and the density.}
\end{wrapfigure}
