\emph{I missed this lecture. This lecture. The notes I'm including here for this lecture are copied from Shmuel's handwritten notes as closely to word for word as I could, and are not based on the lecture itself.}
\section{Intestellar Medium}
The ISM includes
\begin{itemize}
    \item Gas
    \item Dust
    ...
    \item Dark Matter
\end{itemize}
There isn't a property that is uniform across all the ISM, and the ISM is inhomogenous. Some areas are molecular, some are atomic, and some are ionized. Typical values for the temperature and density of the various states of matter are
\begin{table}[!htb]
    \centering
    \begin{tabular}{l|c|c}
