...
\begin{equation}
    \Delta E \propto \gamma_1 \gamma_2 \mu^6
\end{equation}
\(\gamma_1\) is the electron's gyromagnetic ratio instead of the electrons, which is 3 orders of magnitude larger. The reduced mass is half the proton's mass. If we sum both contributions we find that the energy difference is larger by 2 orders of magnitude, which is the difference in frequencies.
