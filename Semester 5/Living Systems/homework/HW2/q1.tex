...
\end{equation}
since \(\omega_1<0\), \(\omega\) is imaginary. If \(\Im(\omega)<0\), any created waves will decay and the system as a whole will be stable. Otherwise, waves will grow exponentially, meaning the system is unstable.
