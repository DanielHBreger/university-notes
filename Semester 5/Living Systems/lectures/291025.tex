...
\begin{figure}[!htb]
	\centering
  	\includegraphics[width=0.5\textwidth]{polarvsisotropic.png}
...
\begin{figure}[!htb]
	\centering\includegraphics[width=0.5\textwidth]{phasetransition_arrows}
...
\begin{figure}[!htb]
	\centering\includegraphics[width=0.5\textwidth]{transitionarea}
	\caption{A smooth phase transition with Domain Wall $\xi$.}
\end{figure}

We'll find a finite range around 0 of width $\rchi$ in which $\abs{p} \neq p_{eq}$. This region is called the Domain Wall.
