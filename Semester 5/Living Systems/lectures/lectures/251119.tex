...
\begin{equation}
	\langle x \rangle = \frac{\sum\limits_i x_i e^{-\beta(H_0-fx_i)}}{\sum\limits_i e^{-\beta (H_0-fx_i)}}
\end{equation}
therefore
\begin{align}
...
\begin{equation}
	k_B T\diffp{\langle x \rangle}{f} = \langle x^2\rangle - \langle x \rangle^2
\end{equation}
...
\begin{equation}
	k_B T \frac{\overline{x}(t)-\langle x \rangle}{f} = \langle x(t)x(0)\rangle -\langle x \rangle^2
\end{equation}
where \(\overline{x}(t)\) is the average given by the starting conditions out of equilibrium. A full development can be found in the appendixes.
\newpage
...
and we found that
\begin{align}
	\langle \delta x(0)\delta x(t)\rangle &= \frac{k_B T}{f}\overline{\delta x} = \frac{k_B T}{f}\int\limits_{-\infty}^0\dd t' \chi(t-t') f\\
	&= k_B T\int\limits_t^\infty\dd t'' \chi(t'')
\end{align}
differentiating we find
\begin{equation}
	\diff{C}{t} = - k_B T\chi(t),\quad t\geq 0
\end{equation}
...
and we find
\begin{equation}
	\hat C(\omega) = \frac{2k_B T}{\omega}\hat\chi''(\omega)
\end{equation}
