...
\newcommand{\eqdetails}{\textcolor{red}{[need details\dots] }}
\newcommand{\details}{\textcolor{red}{[need to add details here\dots]}}
\newcommand{\diagram}{\textcolor{red}{[need to add diagram \& details here\dots]}}
